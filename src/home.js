...
const Home = () => {
    ...
    // Function to update copies when typing directly into the input
    ...
    // New functions for the + and - buttons
    ...
    const styles = `
        ...
        /* Styles for the new copies component */
        .copies-container {
            display: flex;
            align-items: center;
            gap: 6px;
        ...
        .copies-input::-webkit-inner-spin-button {
            -webkit-appearance: none; /* Hide spinners for Chrome, Safari, etc. */
            margin: 0;
        }
        .copy-btn {
            width: 28px;
        ...
        <div className="scheduler-container-wrapper">
            ...
            <div className="scheduler-container">
                ...
                <section className="info-bar">
                    ...
                    <div className="info-item">Time : {new Date().toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit' })}</div>
